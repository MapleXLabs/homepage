...
const items = [
  {
    ...
    blurb: 'Gold-backed digital tokens. End-to-end product engineering, from contract design to the user-facing application.',
  ...
  },
  {
    ...
    blurb: 'Digital authentication for high-value physical objects. Platform engineering and product delivery on the ICP / DFINITY stack.',
    role: 'Platform · product',
    url: 'https://origyn.com',
  },
  {
    name: 'Spectral Waves',
    tag: 'Product · AI signal analysis',
    blurb: 'A modern platform for working with spectral data. Full-stack build with AI-augmented analysis at its core.',
    role: 'Full-stack · ML',
  ...
  },
  {
    ...
    blurb: 'Engineering consulting on PerfusionX, an ETH-affiliated initiative advancing ex-vivo organ perfusion.',
    role: 'Engineering consulting',
    url: 'https://www.perfusionx.ch',
  },
  {
    name: 'Liver4Life',
    tag: 'Research · medical engineering',
    blurb: 'Long-running research collaboration that achieved week-long ex-vivo human liver perfusion — a foundation of our medical-engineering practice.',
    role: 'Research · founding',
            ...
            const inner = (
              <>
                <div>
                  ...
                  <span className="font-mono text-[11px] tracking-[0.08em] uppercase text-neutral-500">{it.tag}</span>
                </div>
                <p className="text-[16px] text-neutral-700 m-0 max-w-[55ch]">{it.blurb}</p>
                <div className="font-mono text-[12px] tracking-[0.08em] uppercase text-neutral-500">Role · {it.role}</div>
